...
Understanding of CMS architecture and workflow

Practical experience with full-stack TypeScript development

Working with relational databases (PostgreSQL)

API development and integration between frontend and backend

Experience in building scalable, role-based systems (Admin/User)
